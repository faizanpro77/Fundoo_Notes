...
return(
    <View style={{height:'100%',width:'100%'}}>
        ...
        <View>
            <TouchableOpacity style={{top:30,height:20,width:50,backgroundColor:'red',justifyContent:'center'}} onPress={getImagefromlibrary}>
            <Text>take Photo from Gallary</Text>
            </TouchableOpacity>
        </View>
        <View>
            <TouchableOpacity style={{top:30,height:20,width:50,backgroundColor:'red',justifyContent:'center'}} onPress={uploadUserImageInto}>
            <Text>upload</Text>
            </TouchableOpacity>
        </View>
    </View>
