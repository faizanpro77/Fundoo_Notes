...
class ResetPasswordScreen extends Component {
    ...
    validatePassword1 = (val) => {
        ...
        validatePassword2 =(val) => {
            ...
            let isValid = rjx.test(val)
            if(!isValid)
                this.setState({ passwordError2:'invalid password'})
            else
        ...
        return (
            <View style={styles.container1}>
                ...
                <View style={styles.container2}>
                    ...
                    <View>
                            <TextInput placeholder='Password' secureTextEntry={true} style={styles.TextInput} onChangeText={this.validatePassword1} />
                            <Text style={styles.regexredError}>{this.state.passwordError1}</Text>
                        </View>

                        <View>
                            <TextInput placeholder='Confirm Password' secureTextEntry={true} style={styles.TextInput} onChangeText={this.validatePassword2} />
                            <Text style={styles.regexredError}>{this.state.passwordError2}</Text>
                        </View>
